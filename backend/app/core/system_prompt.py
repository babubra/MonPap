...
Пример когда оба уровня (родитель и дочерняя) новые:
```json
{
  "status": "ok",
  "type": "expense",
  ...
  "currency": "RUB",
  "category_id": null,
  "category_name": "Игрушки для Полины",
  "category_is_new": true,
  "category_icon": "🧸",
  "category_parent_name": "Игрушки",
  "category_parent_id": null,
  "category_parent_icon": "🎮",
  "counterpart_id": null,
  "counterpart_name": null,
  "counterpart_is_new": false,
  "date": "2026-03-15",
  "raw_text": "купил игрушку Полине за 2000, категория Игрушки для Полины, родитель Игрушки"
}
```
...
- Для cаtegory_icon и category_parent_icon используй один подходящий emoji-символ.
